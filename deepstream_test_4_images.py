...
#input_file = '/workspace/ssl_project/images/cars_cut2.h264'
input_file= None
...
def main(args):
   ...
   # source = Gst.ElementFactory.make("filesrc", "file-source")
    source = Gst.ElementFactory.make("multifilesrc", "image-source")
    if not source:
        sys.stderr.write(" Unable to create Source \n")

    print("Creating H264Parser \n")
    #h264parser = Gst.ElementFactory.make("h264parse", "h264-parser")
    h264parser = Gst.ElementFactory.make("jpegparse", "jpeg-parser")
    if not h264parser:
    ...
    print("Setting Caps to Convert Image to Video Stream \n")
    capsfilter = Gst.ElementFactory.make("capsfilter", "capsfilter")
    capsfilter.set_property("caps", Gst.Caps.from_string("video/x-raw, format=NV12, framerate=10/1"))
